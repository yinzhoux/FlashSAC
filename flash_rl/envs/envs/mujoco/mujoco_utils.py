...
def convert_observation_to_space(observation):
    if isinstance(observation, dict):
        ...
        space = spaces.Box(low=low, high=high, dtype=observation.dtype)
    else:
...
class MujocoTrait:
    ...
    def render(self,
        ...
        try:
            ...
            # Gymnasium's newer MujocoEnv.render() is keyword-free and uses
            # self.render_mode configured on the env instance.
            if mode is not None:
